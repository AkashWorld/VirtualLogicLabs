...
public class HEXGate : MonoBehaviour, LogicInterface
{
    ...
    private GameObject HEXGameObject;
    ...
    void Start()
    {
        HEXGameObject = GameObject.Find("74LS04");
        ...
        for (int i = 0; i < 14; i++)
        {
            ...
            logicNode.transform.parent = HEXGameObject.transform; //sets the Protoboard game object as logicNode_0's parent
