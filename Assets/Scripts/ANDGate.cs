...
public class ANDGate : MonoBehaviour, LogicInterface
{
    ...
    private GameObject ANDGameObject;
    ...
    void Start()
    {
        ANDGameObject = GameObject.Find("74LS08");
        ...
        for (int i = 0; i < 14; i++)
        {
            ...
            logicNode.transform.parent = ANDGameObject.transform; //sets the Protoboard game object as logicNode_0's parent
    ...
    void OnMouseDrag()
    {
        ...
        GameObject node_left;
            ...
            if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 0, out node_left))
            {
                ...
                ANDGameObject.transform.position = offsetPosition;
            }
        }
